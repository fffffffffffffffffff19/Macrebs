...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option => option
            ...
            .addChoices(
                ...
                { name: 'Ajudante', value: '₊˚๑ Ajudante - ꒰阿꒱・₊˚ɞ' },
                { name: 'Eventos', value: '₊˚๑ Eventos - ꒰卡꒱・₊˚ɞ' },
                { name: 'Designer', value: '₊˚๑ Designer - ꒰苏꒱・₊˚ɞ' },
    ...
    async execute(interaction) {
        ...
        const roleStaffMain = await interaction.guild.roles.cache.find(role => role.id == '996510392689905665');
        const divider = await interaction.guild.roles.cache.find(role => role.id == '1041755217974280222');
        ...
        .then(msg => setTimeout(() => { msg.delete() }, 10000)).catch(e => console.log('Não posso enviar msg na dm desta pessoa.'));
