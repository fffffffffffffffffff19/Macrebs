...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const vipRole = await interaction.guild.roles.cache.find((role) => role.name == vip);
        ...
        await vipStatusDB.create({ User_ID: member.id, VipRole: vipRole.name, Giver: interaction.user.id, Time_Created: Time().timeNow, Time_Expired: Time().timeSet });
    },
};
